...
function pikachu(){
  ...
  var pikachu = "Pikachu is a yellow Pokémon own by Ash a Pokémon trainer. He can shoot lightning bolts from his tail.";
...
function charizard(){
  ...
  var charizard = "Charizard is a dragon Pokémon that can breathe fire and possess the ability to fly.";
...
function blastoise(){
  ...
  var blastoise= "Blastoise is a tortoise like Pokémon which can squirt water out of his powerful cannon.";
...
function venusaur(){
  ...
  var venusaur = "Venusaur is a plant Pokémon which can shoot vines out of his back.";
...
function haunterin(){
  ...
  var haunter = "Haunter is a ghost Pokémon which can disappear before your very eyes.";
...
function porygon(){
  ...
  var haunter = "Porygon is a shape shifting Pokémon which can disfigure his shape.";
